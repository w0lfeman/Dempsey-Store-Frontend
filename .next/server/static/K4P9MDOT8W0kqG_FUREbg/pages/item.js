...
class SingleItem_SingleItem extends external_react_["Component"] {
  render() {
    return __jsx(external_react_apollo_["Query"], {
      ...
      return __jsx(SingleItemStyles, null, __jsx(head_default.a, null, __jsx("title", null, "Sick Fits | ", data.item.title)), __jsx("img", {
...
/* harmony default export */ var item = __webpack_exports__["default"] = (Item);
