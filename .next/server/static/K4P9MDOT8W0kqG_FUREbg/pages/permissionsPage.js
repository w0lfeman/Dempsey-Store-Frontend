...
module.exports = __webpack_require__("FvE7");
...
})(["border-spacing:0;width:100%;border:1px solid ", ";thead{font-size:10px;}td,th{border-bottom:1px solid ", ";border-right:1px solid ", ";padding:5px;position:relative;&:last-child{border-right:none;width:150px;button{width:100%;}}label{display:block;padding:10px 5px;}}tr{&:hover{background:", ";}}"], props => props.theme.offWhite, props => props.theme.offWhite, props => props.theme.offWhite, props => props.theme.offWhite);
...
const Permissions = props => __jsx(external_react_apollo_["Query"], {
  ...
  key: permission
}, permission)), __jsx("th", null, "\uD83D\uDC47\uD83C\uDFFB"))), __jsx("tbody", null, data.users && data.users.map(user => __jsx(Permissions_UserPermissions, {
  user: user,
  key: user.id
})))))));
...
class Permissions_UserPermissions extends external_react_default.a.Component {
  ...
  render() {
    ...
    })))), __jsx("td", null, __jsx(SickButton["a" /* default */], {
      type: "button",
      disabled: loading,
...
// CONCATENATED MODULE: ./pages/permissionsPage.js

var permissionsPage_jsx = external_react_default.a.createElement;



const PermissionsPage = props => permissionsPage_jsx("div", null, permissionsPage_jsx(PleaseSignin["a" /* default */], null, permissionsPage_jsx(components_Permissions, null)));

/* harmony default export */ var permissionsPage = __webpack_exports__["default"] = (PermissionsPage);
