...
module.exports = __webpack_require__("SDvi");
...
class RequestReset_Signin extends external_react_["Component"] {
  ...
  render() {
    return RequestReset_jsx(external_react_apollo_["Mutation"], {
      ...
      return RequestReset_jsx(Form["a" /* default */], {
        method: "post",
        onSubmit: async e => {
          e.preventDefault();
          await reset();
...
// CONCATENATED MODULE: ./pages/signupPage.js

var signupPage_jsx = external_react_default.a.createElement;




const Columns = external_styled_components_default.a.div.withConfig({
  displayName: "signupPage__Columns",
  componentId: "sc-1cepogp-0"
})(["display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));grid-gap:20px;"]);

const SignupPage = () => signupPage_jsx(Columns, null, signupPage_jsx(SignUp, null), signupPage_jsx(components_Signin["a" /* default */], null), signupPage_jsx(RequestReset, null));

/* harmony default export */ var signupPage = __webpack_exports__["default"] = (SignupPage);
